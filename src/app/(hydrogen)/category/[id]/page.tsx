...
export default function Page({ params: paramsPromise }: { params: Promise<Params> }) {
  ...
  return (
    <HydrogenLayout>
      ...
      {(isLoading || Object.values(categoryData)?.length == 0)  ? <p>Loading</p> : <CreateCategory id={params.id} category={categoryData} hideFields={true} />}
      </>
    </HydrogenLayout>
  );
}
