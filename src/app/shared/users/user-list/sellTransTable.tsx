...
import { getSellColumns, getTransactionColumns } from './sellTransColumns';
const FilterElement = dynamic(
  () => import('./filter-sell-trans-element'),
  { ssr: false }
);
...
export default function TransactionTable({ data = [],showFields }: { data: any[], showFields:Boolean }) {
...
export function SellTable({ data = [], showFields, name }: { data: any[], showFields:Boolean , name: string}) {
  const [pageSize, setPageSize] = useState(10);
